...
public class DeleteSong extends javax.swing.JFrame {
    ...
    /**
     * Class that deletes a song from the database
     */
    public void DeleteSongFromDatabase() {
        boolean error = false;
        int thisError = 0;
        String SQLStatement = "";
        ...
        if(error == false) {
            ...
            SQLStatement = "delete from `Songs` where `SongID` = " + ID;
            ...
            if(thisError == 0) {
                ...
                myMessage.setMessage("The Song has been successfully deleted from the database!");
                myMessage.setVisible(true);
            }
        }
        else {
    ...
    private void initComponents() {
        ...
        setTitle("GWBC Order of Service Manager - Delete Song");
        setResizable(false);
        ...
        lTitle.setText("GWBC Delete Song");
     ...
     * Runs the DeleteSongFromDatabase method
     * @param evt 
     */
