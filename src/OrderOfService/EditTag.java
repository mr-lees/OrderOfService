...
public class EditTag extends javax.swing.JFrame {
    ...
    /**
     * Class that edits the tag in the database
     */
    public void EditTagInDatabase() {
        boolean error = false;
        int thisError = 0;
        String SQLStatement = "";
        ...
        //Check to see if the user has given a TagDescription and if it fits the length
        ...
        if(error == false) {            
            ...
            String Description = tfTagDesc.getText();
            
            SQLStatement = "update `Tags` "
                    + "set `TagDescription` = '" + Description + "' where `TagID` = " + ID;         
    ...
    private void initComponents() {
        ...
        setTitle("GWBC Order of Service Manager - Edit Tag");
        setResizable(false);
     ...
     * Runs the EditTagInDatabase method
     * @param evt 
     */
