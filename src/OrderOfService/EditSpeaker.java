 ...
 * @author natha
 */
public class EditSpeaker extends javax.swing.JFrame {

    /**
     * Creates new form EditSpeaker
     */
    public EditSpeaker() {
        initComponents();
    }
    ...
    /**
     * Class that edits the speaker in the database
     */
    public void EditSpeakerInDatabase() {
        boolean error = false;
        int thisError = 0;
        String SQLStatement = "";
        ...
        //Check to see if the user has given a Name and if it fits the length
        ...
        if(error == false) {            
            ...
            SQLStatement = "update `Speakers` "
                    + "set `SpeakerName` = '" + Name + "' where `SpeakerID` = " + ID;         
    ...
    private void initComponents() {
        ...
        setTitle("GWBC Order of Service Manager - Edit Speaker");
        setResizable(false);
        ...
        lTitle.setText("GWBC Edit Speaker");
        ...
        lName.setForeground(new java.awt.Color(31, 56, 100));
        lName.setText("Enter Full Name*:");
     ...
     * Runs the EditSpeakerInDatabase method
     * @param evt 
     */
    private void bSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSubmitActionPerformed
        EditSpeakerInDatabase();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditSpeaker.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditSpeaker().setVisible(true);
            }
        });
    }
